...
public class APICourseController {
  ...
  @Autowired
  private CourseRepository entryRepository;

  @PostMapping
  @ResponseStatus(HttpStatus.CREATED)
  public Course create(@RequestBody @Valid Course entry) {
  ...
  @PutMapping("/{id}")
  public Course update(@PathVariable long id, @RequestBody @Valid Course entry) {
    entry.setId(id);
    return entryRepository.save(entry);
  }
